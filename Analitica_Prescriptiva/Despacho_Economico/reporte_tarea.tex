...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{economic-dispatch.jpg}
...
En este trabajo se implementa un caso práctico presentado en la literatura, donde se formula un modelo de despacho económico de carga y se resuelve utilizando Pyomo, una biblioteca de optimización en Python. Se presenta una descripción detallada del problema, la formulación matemática del modelo, la implementación en Pyomo, y la interpretación de los resultados obtenidos.
\newpage
